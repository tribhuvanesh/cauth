...
\documentclass[12pt]{report}			% For LaTeX 2e
...
\oddsidemargin	=6.35mm		% beyond 25.mm
\evensidemargin	=6.35mm		% beyond 25.mm
\headheight	=0.mm
\headsep	=5.mm
\footskip	=10.mm
\textheight	=220.mm
\textwidth	=165.mm
					% SOME USEFUL OPTIONS:
 % \pagestyle{fancyhdr}			% no page numbers
 \parindent   0.mm			% indent paragraph by this much
 \parskip     2.mm			% space between paragraphs
% \mathindent 20.mm			% indent math equations by this muc 0
...
\includegraphics[scale=0.045]{img/msrit.jpg}\\[10ex]
...
This can be implemented by extrapolating the tried-and-tested static authentication techniques throughout the session.
...
\\[6ex]
\end{center}
Being able to finish this project would not be possible without a lot of people involved in making it a successful one. We would like to take this opportunity to express our gratitude to the following people.
...
\chapter{ Introduction }	% start the first numbered section
...
%Klosterman and Granger in their study\cite{Klos00} delineate authentication based on static and continuous methods.
...
\begin{figure}
	...
	\subfloat[Face detection runs on the captured image and shirt position is detected.]{%
		\label{fig:pwd1}%
		\includegraphics[scale=0.35]{img/ss/pos2.png}}
	\quad
	\subfloat[Frame converted to HSV to analyse colour composition]{%
		\label{fig:pwd2}%
		\includegraphics[scale=0.35]{img/ss/pos2_hsv.png}}
	\caption{Soft Biometrics computation}
\end{figure}
...
\begin{figure}
	...
	\subfloat[Face detection detects with high accuracy even in natural positions]{%
		\label{fig:soft3_org}%
		\includegraphics[scale=0.35]{img/ss/pos1.png}}
	\quad
	\subfloat[Frame converted to HSV to analyze colour composition]{%
		\label{fig:soft3_csv}%
		\includegraphics[scale=0.35]{img/ss/pos1_hsv.png}}
	\caption{Flexibility in postures}
\end{figure}
...
\begin{figure}
	...
	\subfloat[Face detection runs on captured image and new colour composition is enrolled]{%
		\label{fig:soft5_org}%
		\includegraphics[scale=0.35]{img/ss/oc0.png}}
	\quad
	\subfloat[Frame converted to HSV to analyze colour composition]{%
		\label{fig:soft5_csv}%
		\includegraphics[scale=0.35]{img/ss/oc0_hsv.png}}
	\caption{Occlusion}
\end{figure}
%$\cdot$\\[10ex]
%$\cdot$\\[10ex]
...
\begin{figure}
	...
	\subfloat[Authenticated user is in front of the system]{%
		\label{fig:soft1}%
		\includegraphics[scale=0.50]{img/soft_conf.png}}
	\quad
	\subfloat[Authenticated user is tailgated]{%
		\label{fig:softa}%
		\includegraphics[scale=0.50]{img/soft_conf_away.png}}
...
\begin{figure}
	...
	\subfloat[Output received from the Face recognition module]{%
		\label{fig:svm1}%
		\includegraphics[scale=0.50]{img/no_svm.png}}
	\quad
	\subfloat[Confidence estimated by SVM using Face recognition data]{%
		\label{fig:svm2}%
		\includegraphics[scale=0.50]{img/svm.png}}
...
\begin{figure}[h!]
	\centering
	\includegraphics[scale=0.50]{img/t_fno.png}
...
\begin{figure}
	\centering
	\subfloat[Alternating between Hard and Soft biometrics mode]{%
		\label{fig:trans1}%
		\includegraphics[scale=0.50]{img/trans_1.png}}
	\quad
	\subfloat[Transition when user is tailgated]{%
		\label{fig:trans2}%
		\includegraphics[scale=0.50]{img/trans_2.png}}
...
\newpage
\chapter{ Appendix }
\section{ Screen Snapshots}
\begin{figure}[h!]
	\centering
	\subfloat[Average image of 250 face images]{%
		\label{fig:ssavg}%
		\includegraphics[scale=1]{img/avg.jpeg}}
\end{figure}

\begin{figure}
	\centering
	\subfloat[Eigenvectors for training dataset]{%
		\label{fig:sseig}%
		\includegraphics[scale=0.35]{img/eigen.png}}
\end{figure}

\begin{figure}
	\centering
	\subfloat[Authorized access state]{%
		\label{fig:trans1}%
		\includegraphics[scale=0.35]{img/ss/h_auth.png}}
	\quad
	\subfloat[Authenticating state]{%
		\label{fig:trans1}%
		\includegraphics[scale=0.35]{img/ss/h_authenticating.png}}
	\quad
	\subfloat[Unauthorized access state]{%
		\label{fig:trans1}%
		\includegraphics[scale=0.35]{img/ss/h_unauth.png}}
	\caption{The three states as recognized by the system}
\end{figure}
...
\begin{figure}
	...
	\subfloat[]{%
		\label{fig:trans1}%
		\includegraphics[scale=0.35]{img/ss/pos3.png}}
	\quad
	\subfloat[]{%
		\label{fig:trans1}%
		\includegraphics[scale=0.35]{img/ss/pos3_hsv.png}}
	\caption{Flexibility in postures using Soft biometrics}
\end{figure}
...
\begin{figure}
	...
	\subfloat[]{%
		\label{fig:trans1}%
		\includegraphics[scale=0.35]{img/ss/t1.png}}
	\quad
	\subfloat[]{%
		\label{fig:trans1}%
		\includegraphics[scale=0.35]{img/ss/t2.png}}
	\quad
	\subfloat[]{%
		\label{fig:trans1}%
		\includegraphics[scale=0.35]{img/ss/t3.png}}
	\quad
	\subfloat[]{%
		\label{fig:trans1}%
		\includegraphics[scale=0.35]{img/ss/t4.png}}
	\quad
	\subfloat[]{%
		\label{fig:trans1}%
		\includegraphics[scale=0.35]{img/ss/tg1.png}}
	\caption{Progressing to soft biometrics mode}
\end{figure}
...
\begin{figure}
	...
	\subfloat[]{%
		\label{fig:trans1}%
		\includegraphics[scale=0.35]{img/ss/tg2.png}}
	\quad
	\subfloat[]{%
		\label{fig:trans1}%
		\includegraphics[scale=0.35]{img/ss/tg3.png}}
	\quad
	\subfloat[]{%
		\label{fig:trans1}%
		\includegraphics[scale=0.35]{img/ss/tg4.png}}
	\caption{User being tailgated}
\end{figure}
